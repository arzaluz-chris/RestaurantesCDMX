/*
 * RestaurantesCentroCDMX - Fragmento para la categoría de comida
 *
 * Este fragmento muestra los elementos de comida de un restaurante
...
/**
 * Fragmento que muestra los elementos de comida del restaurante
 */
class FoodFragment : Fragment() {
    ...
    companion object {
         ...
         */
        fun newInstance(restaurant: Restaurant): FoodFragment {
    ...
    /**
     * Carga los elementos de comida del restaurante
     */
    private fun loadFoodItems() {
        ...
        if (foodItems.isEmpty()) {
            ...
            menuItemAdapter.updateList(foodItems)
        }
    }
