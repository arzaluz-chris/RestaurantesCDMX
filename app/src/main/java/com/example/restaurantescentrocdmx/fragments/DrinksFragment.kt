/*
 * RestaurantesCentroCDMX - Fragmento para la categoría de bebidas
 *
 * Este fragmento muestra los elementos de bebidas de un restaurante
...
/**
 * Fragmento que muestra los elementos de bebidas del restaurante
 */
class DrinksFragment : Fragment() {
    ...
    companion object {
         ...
         */
        fun newInstance(restaurant: Restaurant): DrinksFragment {
            return DrinksFragment().apply {
    ...
    /**
     * Carga los elementos de bebidas del restaurante
     */
    private fun loadDrinkItems() {
        val drinkItems = restaurant.drinkItems
        ...
        if (drinkItems.isEmpty()) {
            ...
            menuItemAdapter.updateList(drinkItems)
        }
    }
